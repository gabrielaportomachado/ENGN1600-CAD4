...
N 1590 -10 1660 -10 {lab=Cout-1}
N 1600 -260 1660 -260 {lab=P0}
N 1600 -220 1660 -220 {lab=P1}
N 1600 -180 1660 -180 {lab=P2}
N 1600 -140 1660 -140 {lab=P3}
N 1860 -200 1920 -200 {lab=BP}
N 1720 -80 1720 -30 {lab=BP}
N 1360 70 1660 70 {lab=#net4}
N 1780 30 1920 30 {lab=Cout}
...
C {lab_wire.sym} 610 -160 0 0 {name=p8 sig_type=std_logic lab=P2}
...
C {lab_wire.sym} 610 -20 0 0 {name=p13 sig_type=std_logic lab=P2}
...
C {lab_wire.sym} 980 30 0 0 {name=p23 sig_type=std_logic lab=P2}
...
C {opin.sym} 1920 30 0 0 {name=p14 lab=Cout}
C {MUX21.sym} 1720 30 0 0 {name=x11}
C {AND4.sym} 1720 -200 0 0 {name=x12}
C {lab_wire.sym} 1640 -260 0 0 {name=p39 sig_type=std_logic lab=P0}
C {lab_wire.sym} 1640 -220 0 0 {name=p40 sig_type=std_logic lab=P1}
C {lab_wire.sym} 1640 -180 0 0 {name=p41 sig_type=std_logic lab=P2}
C {lab_wire.sym} 1640 -140 0 0 {name=p42 sig_type=std_logic lab=P3}
C {opin.sym} 1920 -200 0 0 {name=p43 lab=BP}
C {lab_wire.sym} 1720 -70 2 0 {name=p44 sig_type=std_logic lab=BP}
...
C {lab_wire.sym} 1640 -10 0 0 {name=p34 sig_type=std_logic lab=Cout-1}
