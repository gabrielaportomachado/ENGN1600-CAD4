...
C {lab_wire.sym} 520 -20 0 1 {name=p14 sig_type=std_logic lab=Bb}
C {lab_wire.sym} 520 160 0 1 {name=p15 sig_type=std_logic lab=Bb}
C {ENGN1600-CAD4/INV.sym} 950 -180 2 0 {name=x1}
C {lab_wire.sym} 850 -180 2 0 {name=p17 sig_type=std_logic lab=Bb}
C {ENGN1600-CAD4/INV.sym} 0 -190 0 0 {name=x0}
C {lab_wire.sym} 150 -10 0 1 {name=p5 sig_type=std_logic lab=Ab}
