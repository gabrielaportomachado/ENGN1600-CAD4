...
N -380 -180 -320 -180 {lab=SEL0}
N -380 -120 -330 -120 {lab=SEL1}
C {MUX21.sym} -60 -90 0 0 {name=x1}
C {ipin.sym} -180 -130 0 0 {name=p1 lab=IN0}
C {ipin.sym} -180 -50 0 0 {name=p2 lab=IN1}
C {ipin.sym} -380 -180 0 0 {name=p3 lab=SEL0}
C {ipin.sym} -380 -120 0 0 {name=p4 lab=SEL1}
C {lab_wire.sym} -60 -190 0 0 {name=p5 sig_type=std_logic lab=SEL0}
...
C {lab_wire.sym} 310 -100 0 0 {name=p11 sig_type=std_logic lab=SEL1}
